...
export class JavaScriptExpert extends BaseExpert {
  constructor(id: string = 'javascript', initialConfidence: number = 0.8) {
    super(id, ExpertType.Language, initialConfidence);
  }

  async analyze(code: string, context: CodeContext): Promise<ExpertAnalysis> {
  ...
  private checkCommonIssues(code: string, issues: CodeIssue[]): void {
